#include <stdio.h>
#include <string.h>
#include <inttypes.h>                  // รองรับ PRId32 specifier ใน ESP-IDF v6.0.2
...
static void test_handshake_ip_phase(const char *test_title, const char *ssid,
    ...
    // Initializing structure for ESP-IDF v6.0.2 compliance
...
void app_main(void) {
    ...
    ESP_LOGI(TAG, "==================================================================");
    ESP_LOGI(TAG, "  Lab 5.4: 4-Way Handshake & IP Assignment Phase (ESP-IDF v6.0.2)");
    ESP_LOGI(TAG, "==================================================================");
